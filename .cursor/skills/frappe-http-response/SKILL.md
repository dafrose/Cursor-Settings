...
description: >-
  ...
  codes are applied automatically vs set explicitly. Use when building
  whitelisted APIs, custom JSON envelopes, file downloads, redirects, REST
...
- Official: [Responses](https://docs.frappe.io/framework/user/en/python-api/response) (maps `build_response`, download example, `display_content_as`).
