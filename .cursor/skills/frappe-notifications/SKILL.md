...
Use when authoring or debugging Desk **Notification** rows, email Jinja templates,
recipient conditions, or tests that expect alerts on document events.
...
- [`frappe-testing`](frappe-testing/SKILL.md) — assert notifications via **Communication**
- [`frappe-realtime-website`](frappe-realtime-website/SKILL.md) — live socket alerts vs email persistence
