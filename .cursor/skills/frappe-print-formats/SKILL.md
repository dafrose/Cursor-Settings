...
Use when authoring **Print Format** JSON, fixtures, `bench migrate` sync, Jinja bodies,
or PDF tests with `frappe.get_print`.
...
- [`frappe-testing`](frappe-testing/SKILL.md) — PDF assertions in tests
