...
Use when adding or changing **Web Forms**, routes, `get_context`, or prefill from query
params. Avoid hand-editing exported `web_form` JSON.
...
| `**/*.js` | Client script — colocated file and/or Desk **Client Script**; see [`frappe-web-form-client-script`](../frappe-web-form-client-script/SKILL.md). |
...
- [`frappe-web-form-client-script`](../frappe-web-form-client-script/SKILL.md) — `init_client_script`, success page, Desk vs file
- [`frappe-web-view-templates`](../frappe-web-view-templates/SKILL.md) — Has Web View list/detail templates
