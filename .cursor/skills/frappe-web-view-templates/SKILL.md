...
Use when building or fixing Jinja templates for **DocTypes** with Has Web View—list,
row, and detail pages, `get_list_context`, and portal styling.
...
- [`frappe-web-forms`](frappe-web-forms/SKILL.md) — **Web Form** routes and defaults
