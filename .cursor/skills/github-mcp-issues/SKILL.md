...
- **Drafting copy**: before `issue_write`, use **`draft-github-issue-texts`** — issues must be self-contained; no private-note / transcript / local-only references (see that skill).
...
- [`draft-github-issue-texts`](draft-github-issue-texts/SKILL.md) — self-contained issue bodies; no offline-only refs
- [`github-mcp-pull-requests`](github-mcp-pull-requests/SKILL.md) — PR workflows; default base `develop`
- [`alyf-frappe-app-ci`](alyf-frappe-app-ci/SKILL.md) — branch convention for alyf-de repos
